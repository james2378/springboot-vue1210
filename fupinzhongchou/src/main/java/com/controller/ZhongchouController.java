    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(zhongchou !=null){
            ...
            BeanUtils.copyProperties( zhongchou , view );//把实体数据重构到view中
                ...
                //级联表
                wuziEntity wuzi = wuziService.selectById(zhongchou.getwuziId());
                if(wuzi != null){
    ...
    */
    ...
    public R save(@RequestBody ZhongchouEntity zhongchou, HttpServletRequest request){
        ...
        Wrapper<ZhongchouEntity> queryWrapper = new EntityWrapper<ZhongchouEntity>()
            ...
            .eq("wuzi_id", zhongchou.getwuziId())
        ...
        if(zhongchouEntity==null){
            ...
            wuziEntity wuziEntity = wuziService.selectById(zhongchou.getwuziId());
            zhongchou.setZhongchouMoney(zhongchou.getZhongchouKucunNumber() * wuziEntity.getwuziNewMoney());
...
//                            zhongchouEntity.setwuziId(Integer.valueOf(data.get(0)));   //物资 要改的
